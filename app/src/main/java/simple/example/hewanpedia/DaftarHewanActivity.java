...
public class DaftarHewanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String judul="";
        if (hewans.get(0) instanceof Anggrek) {
            judul = getString(R.string.anggrek_list_title);
        } else if (hewans.get(0) instanceof Kaktus) {
            judul = getString(R.string.kaktus_list_title);
        } else if (hewans.get(0) instanceof Mawar) {
            judul = getString(R.string.mawar_list_title);
        }
